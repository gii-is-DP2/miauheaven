...
INSERT INTO authorities(username, authority) VALUES ('shelter1','animalshelter');
INSERT INTO users(username,password,enabled) VALUES ('shelter2','shelter2',TRUE);
INSERT INTO authorities(username, authority) VALUES ('shelter2','animalshelter');
...
INSERT INTO owners(id,first_name,last_name,address,city,telephone,username) VALUES (11, 'Pichú Animales', 'Shelter', '41410 La Celada', 'Seville', '610839583', 'shelter1');
INSERT INTO owners(id,first_name,last_name,address,city,telephone,username) VALUES (12, 'Arca Sevilla', 'Shelter', '41500 Alcalá de Guadaíra', 'Seville', '6085555487', 'shelter2');
...
INSERT INTO notification(id,title,date,message,target) VALUES (1, '¡Bienvenidos propietarios de animales!', '2013-01-04 13:32', 'Quiero daros la bienvenida a todos los propietarios de animales','owner');
...
INSERT INTO products(id,name,price,stock,description,image) VALUES (1, 'Comida para perros',12.2, true, 'La mejor comida para alimentar a nuestros compañeros caninos', 'https://www.petpremium.com/wp-content/uploads/2012/10/5-healthy-dog-foods-430x226.jpg');
INSERT INTO products(id,name,price,stock,description,image) VALUES (2, 'Comida para gatos',15.4, false, 'La mejor comida para alimentar a nuestros compañeros felinos', 'https://t1.uc.ltmcdn.com/images/1/9/0/img_como_hacer_comida_casera_saludable_para_mi_gato_23091_orig.jpg');
