...
class AdminControllerE2ETest {
	...
	void testNotificationShow() throws Exception {
		this.mockMvc
				.perform(MockMvcRequestBuilders.get("/admin/notification/{notificationId}",
						AdminControllerE2ETest.TEST_NOTIFICATION_ID))
				.andExpect(MockMvcResultMatchers.status().isOk())
				...
				.andExpect(MockMvcResultMatchers.model().attribute("notification",
						Matchers.hasProperty("id", Matchers.is(AdminControllerE2ETest.TEST_NOTIFICATION_ID))))
				.andExpect(MockMvcResultMatchers.model().attribute("notification",
						Matchers.hasProperty("title", Matchers.is("¡Bienvenidos propietarios de animales!"))))
				.andExpect(MockMvcResultMatchers.model().attribute("notification",
						Matchers.hasProperty("message", Matchers.is("Quiero daros la bienvenida a todos los propietarios de animales"))))
				.andExpect(MockMvcResultMatchers.model().attribute("notification",
						Matchers.hasProperty("target", Matchers.is("owner"))))
	...
	void testShowAppointment() throws Exception {
		...
		this.mockMvc
				.perform(MockMvcRequestBuilders
						.get("/admin/appointments/{appointmentId}", AdminControllerE2ETest.TEST_APPOINTMENT_ID))
				.andExpect(MockMvcResultMatchers.status().isOk())
				.andExpect(MockMvcResultMatchers.model().attribute("appointment",
						Matchers.hasProperty("cause", Matchers.is("Operacion"))))
				.andExpect(MockMvcResultMatchers.model().attribute("appointment",
						Matchers.hasProperty("date", Matchers.is(LocalDate.of(2020, 12, 1)))))
				.andExpect(MockMvcResultMatchers.model().attribute("appointment",
	...
	void testProductShow() throws Exception {
		this.mockMvc
				.perform(MockMvcRequestBuilders.get("/admin/product/{productId}", AdminControllerE2ETest.TEST_PRODUCT_ID))
				.andExpect(MockMvcResultMatchers.status().isOk())
				.andExpect(MockMvcResultMatchers.model().attributeExists("product"))
				.andExpect(MockMvcResultMatchers.model().attribute("product",
						Matchers.hasProperty("id", Matchers.is(AdminControllerE2ETest.TEST_PRODUCT_ID))))
				.andExpect(MockMvcResultMatchers.model().attribute("product",
						Matchers.hasProperty("price", Matchers.is(12.2))))
				.andExpect(MockMvcResultMatchers.model().attribute("product",
						Matchers.hasProperty("name", Matchers.is("Comida para perros"))))
				.andExpect(MockMvcResultMatchers.model().attribute("product",
						Matchers.hasProperty("stock", Matchers.is(true))))
				.andExpect(MockMvcResultMatchers.model().attribute("product",
						Matchers.hasProperty("description", Matchers.is("La mejor comida para alimentar a nuestros compañeros caninos"))))
				.andExpect(MockMvcResultMatchers.model().attribute("product",
						Matchers.hasProperty("image", Matchers.is("https://www.petpremium.com/wp-content/uploads/2012/10/5-healthy-dog-foods-430x226.jpg"))))
	...
	void testShowPet() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/admin/pets/{petId}", AdminControllerE2ETest.TEST_PET_ID))
				.andExpect(MockMvcResultMatchers.status().isOk())
	...
	void testShowQuestionnaires() throws Exception {
		this.mockMvc
				.perform(MockMvcRequestBuilders.get("/admin/questionnaires/{questionnaireId}", AdminControllerE2ETest.TEST_QUESTIONNAIRE_ID))
				.andExpect(MockMvcResultMatchers.status().isOk())
				...
				.andExpect(MockMvcResultMatchers.model().attribute("questionnaire",
						Matchers.hasProperty("horasLibres", Matchers.is("Entre 3 y 6 horas"))))
				.andExpect(MockMvcResultMatchers.model().attribute("questionnaire",
