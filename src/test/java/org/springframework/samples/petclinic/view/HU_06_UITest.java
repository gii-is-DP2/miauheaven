...
public class HU_06_UITest {
	...
	public void testPositive() throws Exception {
		...
		this.driver.findElement(By.xpath("//a[contains(text(),'Add New Pet')]")).click();
		...
		this.driver.findElement(By.xpath("//div[@id='ui-datepicker-div']/div/a/span")).click();
		this.driver.findElement(By.xpath("//div[@id='ui-datepicker-div']/div/a/span")).click();
		this.driver.findElement(By.xpath("//div[@id='ui-datepicker-div']/div/a")).click();
		this.driver.findElement(By.xpath("//div[@id='ui-datepicker-div']/div/a")).click();
		this.driver.findElement(By.xpath("//a[contains(text(),'11')]")).click();
	...
	public void testNegative() throws Exception {
		...
		this.driver.findElement(By.id("password")).sendKeys("shelter1");
		this.driver.findElement(By.xpath("//button[@type='submit']")).click();
		this.driver.findElement(By.xpath("//div[@id='main-navbar']/ul/li[4]/a")).click();
		this.driver.findElement(By.xpath("//a[contains(text(),'Add New Pet')]")).click();
		this.driver.findElement(By.id("name")).click();
		this.driver.findElement(By.id("name")).clear();
