...
public class HU_24_UITest {
	...
	public void testPrueba24CasoPositivo() throws Exception {
		...
		new Select(this.driver.findElement(By.name("owner_id"))).selectByVisibleText("BettyDavis");
		this.driver.findElement(By.xpath("//form[@id='record']/div/div/select/option[2]")).click();
