...
public class HU_11_UITest {
	...
	public void testPositive() throws Exception {
		...
		this.driver.findElement(By.xpath("//button[@type='submit']")).click();
		Assert.assertEquals("Prueba", this.driver.findElement(By.xpath("//tr[2]/td/dl/dd")).getText());
	...
	public void testNegative() throws Exception {
		...
		this.driver.findElement(By.xpath("//option[@value='male']")).click();
		this.driver.findElement(By.xpath("//button[@type='submit']")).click();
		Assert.assertEquals("required and between 3 and 50 character", this.driver.findElement(By.xpath("//form[@id='pet']/div/div[2]/div/span[2]")).getText());
