...
public class HU_27_UITEST {
	...
	public void testListaProductos() throws Exception {
		...
		this.driver.findElement(By.xpath("//table[@id='productTable']/tbody/tr/td")).click();
		Assert.assertEquals("Comida para perros", this.driver.findElement(By.xpath("//table[@id='productTable']/tbody/tr/td")).getText());
