...
class AdminControllerTests {
	...
	void setup() {
		...
		this.questionnaire.setOwner(this.george);
		this.questionnaire.setPet(this.leo);
		...
		this.leo.changeOwner(this.george);
		...
		this.appointment.setOwner(this.george);
	...
	void testNotificationShow() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/admin/notification/{notificationId}", AdminControllerTests.TEST_NOTIFICATION_ID)).andExpect(MockMvcResultMatchers.status().isOk())
			.andExpect(MockMvcResultMatchers.model().attributeExists("notification")).andExpect(MockMvcResultMatchers.model().attribute("notification", Matchers.hasProperty("id", Matchers.is(AdminControllerTests.TEST_NOTIFICATION_ID))))
			...
			.andExpect(MockMvcResultMatchers.model().attribute("notification", Matchers.hasProperty("target", Matchers.is("admin")))).andExpect(MockMvcResultMatchers.model().attribute("notification", Matchers.hasProperty("url", Matchers.is("www.us.es"))))
	...
	void testShowAppointment() throws Exception {
		...
		this.mockMvc.perform(MockMvcRequestBuilders.get("/admin/appointments/{appointmentId}", AdminControllerTests.TEST_APPOINTMENT_ID)).andExpect(MockMvcResultMatchers.status().isOk())
	...
	void testProductShow() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/admin/product/{productId}", AdminControllerTests.TEST_PRODUCT_ID)).andExpect(MockMvcResultMatchers.status().isOk()).andExpect(MockMvcResultMatchers.model().attributeExists("product"))
			...
			.andExpect(MockMvcResultMatchers.model().attribute("product", Matchers.hasProperty("price", Matchers.is(10.00)))).andExpect(MockMvcResultMatchers.model().attribute("product", Matchers.hasProperty("name", Matchers.is("Prueba"))))
			.andExpect(MockMvcResultMatchers.model().attribute("product", Matchers.hasProperty("stock", Matchers.is(true)))).andExpect(MockMvcResultMatchers.model().attribute("product", Matchers.hasProperty("description", Matchers.is("Prueba"))))
			.andExpect(MockMvcResultMatchers.model().attribute("product", Matchers.hasProperty("image", Matchers.is("Prueba")))).andExpect(MockMvcResultMatchers.view().name("admin/product/productShow"));
	}
	...
	void testShowPet() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/admin/pets/{petId}", AdminControllerTests.TEST_PET_ID)).andExpect(MockMvcResultMatchers.status().isOk())
	...
	void testShowQuestionnaires() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/admin/questionnaires/{questionnaireId}", AdminControllerTests.TEST_QUESTIONNAIRE_ID)).andExpect(MockMvcResultMatchers.status().isOk())
			...
			.andExpect(MockMvcResultMatchers.model().attribute("questionnaire", Matchers.hasProperty("horasLibres", Matchers.is("Más de 6 horas"))))
	...
	void testEventList() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/admin/events/")).andExpect(MockMvcResultMatchers.status().isOk()).andExpect(MockMvcResultMatchers.model().attributeExists("events"))
	...
	void testEventShow() throws Exception {
		this.mockMvc.perform(MockMvcRequestBuilders.get("/admin/events/{eventId}", AdminControllerTests.TEST_EVENT_ID)).andExpect(MockMvcResultMatchers.status().isOk()).andExpect(MockMvcResultMatchers.model().attributeExists("event"))
			...
			.andExpect(MockMvcResultMatchers.model().attribute("event", Matchers.hasProperty("date", Matchers.is(LocalDate.now())))).andExpect(MockMvcResultMatchers.view().name("admin/events/eventShow"));
	}
}
